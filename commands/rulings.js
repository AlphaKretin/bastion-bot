...
const func = async (msg) => {
    ...
    if (commands_1.botOpts.enLangName && commands_1.botOpts.enLangName in card.text) {
        ...
        try {
            ...
            await msg.channel.createMessage("Rulings for `" + card.text[langs.lang2].name + "`: <" + OCG_DB + dbId + ">");
            return;
        }
        catch (e) {
    ...
    if (commands_1.botOpts.jaLangName && commands_1.botOpts.jaLangName in card.text) {
        ...
        await msg.channel.createMessage("Rulings for `" +
    ...
    await msg.channel.createMessage("Sorry, I couldn't look up rulings for " +
        card.text[langs.lang2].name +
